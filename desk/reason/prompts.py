...
def build_job_c_prompt(check_rows: list[dict], job_a_facts: dict | None) -> str:
    ...
    return (
        ...
        "reporting; if several rows are 'failed' or 'review_required', use the "
        "customer's own words below to judge which one their ticket is really about, "
        "citing that check_id specifically in a claim.\n\n"
