...
Generated: 2026-08-19T05:15:12.365177+00:00
Source run: `2026-08-19T05:15:12.185599+00:00`  ·  replay_only: `True`
Cases in run: **50**
...
n = 40. AI-assisted (the real pipeline, after grounding): **72.5%** (29/40). Deterministic-only baseline (what the system would answer with every model tier disabled, computed by replicating the deterministic template's own tie-break rule over the same check results): **90.0%** (36/40).
...
| `assertion_expired` | `SAML-COND-01` | `SAML-COND-01` (OK) | `SAML-COND-01` (OK) |
...
| `cert_expired` | `SAML-CERT-01` | `SAML-COND-01` (WRONG) | `SAML-CERT-01` (OK) |
| `cert_expired__confident_misdiagnosis` | `SAML-CERT-01` | `SAML-CERT-01` (OK) | `SAML-CERT-01` (OK) |
| `cert_expired__hostile` | `SAML-CERT-01` | `SAML-COND-01` (WRONG) | `SAML-CERT-01` (OK) |
| `cert_expired__non_native` | `SAML-CERT-01` | `SAML-COND-01` (WRONG) | `SAML-CERT-01` (OK) |
| `cert_expired__vague` | `SAML-CERT-01` | `SAML-COND-01` (WRONG) | `SAML-CERT-01` (OK) |
...
| `cert_rotation__hostile` | `SAML-CERT-02` | `SAML-CERT-02` (OK) | `SAML-CERT-02` (OK) |
| `cert_rotation__non_native` | `SAML-CERT-02` | `SAML-CERT-02` (OK) | `SAML-CERT-02` (OK) |
| `cert_rotation__vague` | `SAML-CERT-02` | `SAML-CERT-02` (OK) | `SAML-CERT-02` (OK) |
...
| `clock_skew__vague` | `SAML-SKEW-01` | `SAML-SKEW-01` (OK) | `SAML-SKEW-01` (OK) |
...
| `inresponseto_mismatch` | `SAML-INRESP-01` | `SAML-INRESP-01` (OK) | `SAML-INRESP-01` (OK) |
| `missing_nameid` | `SAML-NAMEID-01` | `SAML-ATTR-01` (WRONG) | `SAML-NAMEID-01` (OK) |
| `missing_nameid__confident_misdiagnosis` | `SAML-NAMEID-01` | `SAML-ATTR-01` (WRONG) | `SAML-NAMEID-01` (OK) |
| `missing_nameid__hostile` | `SAML-NAMEID-01` | `SAML-ATTR-01` (WRONG) | `SAML-NAMEID-01` (OK) |
...
0/42 Job C outputs that actually reached the grounding validator (live or fixture tier only -- the deterministic template is grounded by construction and is never graded) were rejected: **0.0%**.
...
|---|---|---|---|---|
| A | 50 | 1900 ms | 21956 | 6900 |
| B | 46 | 2555 ms | 12300 | 4842 |
| C | 42 | 2940 ms | 83760 | 13186 |
